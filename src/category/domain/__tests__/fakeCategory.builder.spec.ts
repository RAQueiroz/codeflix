...
describe('CategoryFakerBuilder Unit Tests', () => {
  describe('categoryId prop', () => {
    ...
    test('should pass index to category_id factory', () => {
      ...
      const fakerMany = FakeCategoryBuilder.theCategories(2);
  ...
  describe('createdAt prop', () => {
    ...
    test('should throw error when any with methods has called', () => {
      const fakerCategory = FakeCategoryBuilder.aCategory();
  ...
  test('should create many categories', () => {
    const faker = FakeCategoryBuilder.theCategories(2);
